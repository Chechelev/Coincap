...
export function HeaderWallet({ headerCoinCost, showModal }) {
  ...
  return (
    <div data-testid="user-wallet-info-test" className="user-wallet-info" onClick={showModal}>
      ...
      <div data-testid="user-wallet__different-cost-percent" className="user-wallet__different-cost-percent">{(isNaN(percent) || percent == Infinity || percent == -Infinity) ? 0 : totalPercent}%</div>
